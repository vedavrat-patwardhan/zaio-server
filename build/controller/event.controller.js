...
const event_model_1 = (0, tslib_1.__importDefault)(require("../model/event.model"));
const event_service_1 = require("../services/event.service");
const apiError_1 = require("../utils/apiError");
const apiResponse_1 = require("../utils/apiResponse");
const catchAsync_1 = (0, tslib_1.__importDefault)(require("../utils/catchAsync"));
exports.createEvent = (0, catchAsync_1.default)((req, res, _next) => (0, tslib_1.__awaiter)(void 0, void 0, void 0, function* () {
    let { date } = req.body;
    console.log('date', date);
    if ((0, event_service_1.isWeekend)(date)) {
        date = (0, event_service_1.updateToNextMonday)(date);
    }
    const id = (yield event_model_1.default.countDocuments()) + 1;
...
exports.monthlyEvents = (0, catchAsync_1.default)((req, res, next) => (0, tslib_1.__awaiter)(void 0, void 0, void 0, function* () {
